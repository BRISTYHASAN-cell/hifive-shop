...
# Cloudinary configuration (must be before DEFAULT_FILE_STORAGE)
import cloudinary
...
# Internationalization (USA English)
LANGUAGE_CODE = 'en-us'
...
# Media files (uploaded by users) – handled by Cloudinary
# Keep these but they are overridden by DEFAULT_FILE_STORAGE
MEDIA_URL = '/media/'
